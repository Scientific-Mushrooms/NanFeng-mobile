...
import App from './App';
AppRegistry.registerComponent('NF', () => App);
    ...
    render() {
        ...
        return (
            <View style={styles.wrapper}>
                ...
                <Modal style={[styles.modal, styles.modal2]} backdrop={false}  position={"top"} ref={"modal2"} entry={"top"} >
...
AppRegistry.registerComponent('NF', () => Example);*/
